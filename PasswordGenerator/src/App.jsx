...
function App() {
    ...
    // useCallback -> Uses cache (memoization) to for optimization (For better understanding Read React Docs)
    ...
    const copyPasswordToClipboard = useCallback(() => {
        passwordRef.current?.select(); // just to show the selected items on UI
            ...
            <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-800">
                ...
                <div className="flex text-sm gap-x-2">
                    ...
                    <div className="flex items-center gap-x-1">
                        ...
                        />
                        <label htmlFor="characterInpur">Characters</label>
                    </div>
                </div>
            </div>
        </>
